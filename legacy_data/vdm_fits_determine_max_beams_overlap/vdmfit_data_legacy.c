{
   ...
   //form to add trees from different directories//./
    chain->Add(Form ("/eos/home-m/mgadalla/LSC/legacy_data/bias_%d/pcc_Data_PixVtx_Event_90X_*.root",i));
   }
  ...
  Bool_t vtxisgood[1348788089]={false};
  Int_t numvtx;
