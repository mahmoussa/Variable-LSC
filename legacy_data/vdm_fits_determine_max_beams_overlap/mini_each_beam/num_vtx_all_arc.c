{
   //ROOT::Math::MinimizerOptions::SetDefaultMaxFunctionCalls(10000); //to avoid abnormal minimizer warning

   TFile *f = new TFile ("num_vtx_dividedby_events_all_arc.root", "recreate");
   

  // using average values for per beam mini scan step sizes 
	float nomPos_arc_b1y1[] ={ -125.999257618712 , -0.965174166666674 , 121.700610045379 };
	float nomPos_arc_b1y2[] ={ -122.528739318712 , 0.560171487 , 122.025625918629 };
	float nomPos_arc_b1y3[] ={ -121.651030678004 , 1.03784128000003 , 124.219004954046 };
	float nomPos_arc_b1y4[] ={ -121.813939987712 , 1.12904371875 , 124.678169918712 };
	float nomPos_arc_b1y5[] ={ -121.504960418712 , 0.836668616666664 , 124.117754445379 };
	float nomPos_arc_b1x1[] ={ -122.921320188108 , -0.941747843749999 , 122.077437065489 };
	float nomPos_arc_b1x2[] ={ -124.516415688108 , -2.11773649333333 , 121.765176196775 };
	float nomPos_arc_b1x3[] ={ -123.403460444441 , -0.401172946428544 , 125.708397842774 };
	float nomPos_arc_b1x4[] ={ -123.067152263025 , -0.717837824999998 , 122.09469293915 };
	float nomPos_arc_b1x5[] ={ -123.332768186025 , -1.19031816666666 , 121.352272490108 };
	float nomPos_arc_b2y1[] ={ -123.100809883842 , -0.896217186666667 , 124.996751762175 };
	float nomPos_arc_b2y2[] ={ -124.022169382508 , -1.23693588033333 , 120.705533113842 };
	float nomPos_arc_b2y3[] ={ -123.647281993842 , -1.46271982666669 , 121.619652009175 };
	float nomPos_arc_b2y4[] ={ -124.798836137175 , -0.952520668749997 , 121.453742249175 };
	float nomPos_arc_b2y5[] ={ -124.176333568425 , -1.76310044333333 , 121.717983203842 };
	float nomPos_arc_b2x1[] ={ -123.290471065422 , 0.204112884062498 , 126.400500803088 };
	float nomPos_arc_b2x2[] ={ -122.115101105088 , -1.25988816333333 , 122.139592796005 };
	float nomPos_arc_b2x3[] ={ -122.018121091755 , 0.890955333333306 , 122.790578001622 };
	float nomPos_arc_b2x4[] ={ -121.083072723088 , 1.5854841 , 123.106851015088 };
	float nomPos_arc_b2x5[] ={ -123.936456923088 , 1.27429093333333 , 123.358347779755 };
