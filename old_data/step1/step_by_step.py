...
if __name__ == '__main__':
   ...
   makeCalibPlot("B1Y1", "LScalib_B1Y1.root", "plotsLScalib_B1Y1.pdf", 1.06231, 0.137124, 1.76286, 0.137285, 2.51068, 0.137828, -0.386167, 0.137572)
   makeCalibPlot("B1Y2", "LScalib_B1Y2.root", "plotsLScalib_B1Y2.pdf", 0.989891, 0.134682, -0.435383, 0.134638, 2.66673, 0.135318, -0.686923, 0.135956)
   makeCalibPlot("B1Y3", "LScalib_B1Y3.root", "plotsLScalib_B1Y3.pdf", 0.79672, 0.135371, -2.44328, 0.135293, 2.75294, 0.135562, -1.15947, 0.135253)
   makeCalibPlot("B1Y4", "LScalib_B1Y4.root", "plotsLScalib_B1Y4.pdf", -0.18548, 0.136576, -4.49791, 0.136721, 2.69563, 0.136465, -3.06657, 0.136671)
   makeCalibPlot("B1Y5", "LScalib_B1Y5.root", "plotsLScalib_B1Y5.pdf", -0.763582, 0.138063, -5.62564, 0.138071, 2.79399, 0.138078, -4.32112, 0.137978)
   makeCalibPlot("B1X1", "LScalib_B1X1.root", "plotsLScalib_B1X1.pdf", -2.00792, 0.162898, -2.16496, 0.201645, -1.42863, 0.163236, -2.58721, 0.162692)
   makeCalibPlot("B1X2", "LScalib_B1X2.root", "plotsLScalib_B1X2.pdf", -2.02251, 0.159768, -1.34923, 0.19671, -1.32019, 0.160404, -2.7248, 0.160786)
   makeCalibPlot("B1X3", "LScalib_B1X3.root", "plotsLScalib_B1X3.pdf", -1.76047, 0.195393, -2.96049, 0.195211, -1.71158, 0.19537, -1.80934, 0.195415)
   makeCalibPlot("B1X4", "LScalib_B1X4.root", "plotsLScalib_B1X4.pdf", -2.32011, 0.198327, -1.92694, 0.198289, -2.22694, 0.19834, -2.41327, 0.198312)
   makeCalibPlot("B1X5", "LScalib_B1X5.root", "plotsLScalib_B1X5.pdf", -2.02059, 0.198959, -0.769719, 0.198463, -2.28122, 0.198965, -1.75997, 0.198951)
   makeCalibPlot("B2Y1", "LScalib_B2Y1.root", "plotsLScalib_B2Y1.pdf", -3.59287, 0.138735, -2.98208, 0.137569, -5.14996, 0.137651, -2.03556, 0.138797)
   makeCalibPlot("B2Y2", "LScalib_B2Y2.root", "plotsLScalib_B2Y2.pdf", -4.74105, 0.138008, -2.6198, 0.137247, -5.20438, 0.138231, -4.27771, 0.1378)
   makeCalibPlot("B2Y3", "LScalib_B2Y3.root", "plotsLScalib_B2Y3.pdf", -3.48643, 0.138524, -2.11178, 0.138452, -3.84697, 0.139614, -3.12582, 0.138614)
   makeCalibPlot("B2Y4", "LScalib_B2Y4.root", "plotsLScalib_B2Y4.pdf", -1.02001, 0.136375, -0.134141, 0.13529, -0.233315, 0.136672, -1.8067, 0.136096)
   makeCalibPlot("B2Y5", "LScalib_B2Y5.root", "plotsLScalib_B2Y5.pdf", 2.29323, 0.13681, 2.01166, 0.136717, 3.80422, 0.136838, 0.782172, 0.137706)
   makeCalibPlot("B2X1", "LScalib_B2X1.root", "plotsLScalib_B2X1.pdf", 0.396742, 0.194002, 0.193063, 0.194031, -0.954571, 0.194009, 1.74805, 0.193994)
   makeCalibPlot("B2X2", "LScalib_B2X2.root", "plotsLScalib_B2X2.pdf", -3.19252, 0.196725, -1.30541, 0.160653, -5.09176, 0.196189, -1.29324, 0.196747)
   makeCalibPlot("B2X3", "LScalib_B2X3.root", "plotsLScalib_B2X3.pdf", -3.4749, 0.198048, -1.60971, 0.198103, -5.72652, 0.198038, -1.22328, 0.198058)
   makeCalibPlot("B2X4", "LScalib_B2X4.root", "plotsLScalib_B2X4.pdf", -3.56743, 0.207798, -1.72366, 0.207859, -6.42336, 0.207794, -0.711505, 0.207801)
   makeCalibPlot("B2X5", "LScalib_B2X5.root", "plotsLScalib_B2X5.pdf", -6.97774, 0.171108, -3.37143, 0.201207, -10.298, 0.170933, -3.65751, 0.171278)
