...
if __name__ == '__main__':
   ...
   makeCalibPlot("B1Y1", "LScalib_B1Y1.root", "plotsLScalib_B1Y1.pdf" , 1.09411, 0.139595, 1.76286, 0.137285, 2.55128, 0.140989, -0.363169, 0.139356)
   makeCalibPlot("B1Y2", "LScalib_B1Y2.root", "plotsLScalib_B1Y2.pdf" , 0.984383, 0.136385, -0.435383, 0.134638, 2.65584, 0.138646, -0.687039, 0.135991)
   makeCalibPlot("B1Y3", "LScalib_B1Y3.root", "plotsLScalib_B1Y3.pdf" , 0.75329, 0.137772, -2.44328, 0.135293, 2.67979, 0.139604, -1.17318, 0.136012)
   makeCalibPlot("B1Y4", "LScalib_B1Y4.root", "plotsLScalib_B1Y4.pdf" , -0.277752, 0.139384, -4.49791, 0.136721, 2.54769, 0.140967, -3.10319, 0.137785)
   makeCalibPlot("B1Y5", "LScalib_B1Y5.root", "plotsLScalib_B1Y5.pdf" , -0.861556, 0.140469, -5.62564, 0.138071, 2.62394, 0.142252, -4.34702, 0.138615)
   makeCalibPlot("B1X1", "LScalib_B1X1.root", "plotsLScalib_B1X1.pdf" , -2.02158, 0.163943, -2.16496, 0.201645, -1.45058, 0.164929, -2.59258, 0.163099)
   makeCalibPlot("B1X2", "LScalib_B1X2.root", "plotsLScalib_B1X2.pdf" , -2.03984, 0.161833, -1.34923, 0.19671, -1.34449, 0.163164, -2.73517, 0.162075)
   makeCalibPlot("B1X3", "LScalib_B1X3.root", "plotsLScalib_B1X3.pdf" , -1.8282, 0.199859, -2.96049, 0.195211, -1.79021, 0.200555, -1.86618, 0.199162)
   makeCalibPlot("B1X4", "LScalib_B1X4.root", "plotsLScalib_B1X4.pdf" , -2.33643, 0.200005, -1.92694, 0.198289, -2.25352, 0.201075, -2.41932, 0.198934)
   makeCalibPlot("B1X5", "LScalib_B1X5.root", "plotsLScalib_B1X5.pdf" , -2.02552, 0.200236, -0.769719, 0.198463, -2.29016, 0.201279, -1.76088, 0.19919)
   makeCalibPlot("B2Y1", "LScalib_B2Y1.root", "plotsLScalib_B2Y1.pdf" , -3.64001, 0.140843, -2.98208, 0.137569, -5.20616, 0.140242, -2.07365, 0.140523)
   makeCalibPlot("B2Y2", "LScalib_B2Y2.root", "plotsLScalib_B2Y2.pdf" , -4.75987, 0.138991, -2.6198, 0.137247, -5.24444, 0.140324, -4.2753, 0.137674)
   makeCalibPlot("B2Y3", "LScalib_B2Y3.root", "plotsLScalib_B2Y3.pdf" , -3.50541, 0.139769, -2.11178, 0.138452, -3.88224, 0.141918, -3.1285, 0.13879)
   makeCalibPlot("B2Y4", "LScalib_B2Y4.root", "plotsLScalib_B2Y4.pdf" , -1.02166, 0.138032, -0.134141, 0.13529, -0.235921, 0.139277, -1.80741, 0.136805)
   makeCalibPlot("B2Y5", "LScalib_B2Y5.root", "plotsLScalib_B2Y5.pdf" , 2.31474, 0.138272, 2.01166, 0.136717, 3.83957, 0.13924, 0.78985, 0.138226)
   makeCalibPlot("B2X1", "LScalib_B2X1.root", "plotsLScalib_B2X1.pdf" , 0.402765, 0.200048, 0.193063, 0.194031, -0.947668, 0.200939, 1.75319, 0.199156)
   makeCalibPlot("B2X2", "LScalib_B2X2.root", "plotsLScalib_B2X2.pdf" , -3.20891, 0.199195, -1.30541, 0.160653, -5.11866, 0.200224, -1.29912, 0.197634)
   makeCalibPlot("B2X3", "LScalib_B2X3.root", "plotsLScalib_B2X3.pdf" , -3.49812, 0.200907, -1.60971, 0.198103, -5.7621, 0.202416, -1.23416, 0.199397)
   makeCalibPlot("B2X4", "LScalib_B2X4.root", "plotsLScalib_B2X4.pdf" , -3.58846, 0.210333, -1.72366, 0.207859, -6.4581, 0.211983, -0.718819, 0.208683)
   makeCalibPlot("B2X5", "LScalib_B2X5.root", "plotsLScalib_B2X5.pdf" , -7.05565, 0.174828, -3.37143, 0.201207, -10.3969, 0.175648, -3.71438, 0.173999)
